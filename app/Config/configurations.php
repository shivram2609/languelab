...
define("DB_USER","lingovab"); //1337iot
define("DB_PASSWORD","WKhUzrwPfJvR"); //HHsANLWAUwPQJ5Js
define("DB_NAME","lingovab");
/* Database Configurations end */
/* Image and Pdf uploading path, urls and their size's */
	define("FFMPEG_PATH", '/usr/local/bin/ffmpeg'); //ffmpeg path
