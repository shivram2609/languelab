		...
		<?php foreach ($messages as $message) { ?>
			<div class="msg-row-<?php echo (($i%2) == 0)?'even':'od'; ?>">
				...
				<div class="msg-img-txt-rt">
					...
					<a href="<?php echo $this->Html->url(array('controller'=>'message','action' =>$message['Message']['message_id'],'trash')); ?>" class="txt-msg"><?php echo $this->Common->removehtml($message['Message']['newmessage'],100); ?></a>
				</div>
			</div>
		<?php } ?>
		<?php } ?>
