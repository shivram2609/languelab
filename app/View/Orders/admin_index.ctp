<div class="emailtemplates index">
	...
	<tr <?php echo $class;?>>
		...
		<td class="leftalign"><?php echo h(!empty($order['Order']['buyer_id'])?$order['Buyer']['first_name'].' '.$order['Buyer']['last_name']:"LMS"); ?>&nbsp;</td>
		<td class="leftalign"><?php echo h(!empty($order['Order']['seller_id'])?$order['Seller']['first_name'].' '.$order['Seller']['last_name']:"LMS"); ?>&nbsp;</td>
