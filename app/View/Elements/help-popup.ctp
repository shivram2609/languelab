...
<div class="live-sess-popup" style="display:none">
 ...
 <div class="help-popup">
	<div class="cont">
	<p>The title of your course is key to your success as an instructor on LMS so make it good!</p>
...
<div class="live-sess-popup" id="live-sess-popup" style="display:none">
 ...
 <div class="help-popup">
	<div class="cont">
		<p>Having a beautiful, clean, non-pixelated course image is vital to hooking new students. After all, it's the first thing potential students see! It's also what is seen most when a student is perusing LMS. Use an image that both represents your course well and coheres to the 480x270 pixel standard. If you have it, we recommend using an image that is 960x540 for optimal display on the iPad.</p>
		<p>If you don't how to make a course image or use an image editing software like Photoshop, there are several courses on LMS that can help.</p>
	</div>	
	<div class="cont">
...
<div class="live-sess-popup" style="display:none">
	...
	<div class="help-popup">
		<div class="cont">
			<p>
				<h3>Public</h3>
				"Public" courses are available for anyone to take on LMS.
		...
		<br />
			<div id="tabs" class="tabs-pop">
				...
				<div id="tabs-1" class="tabs-1">
					...
					<div class="wrap-1">											
						<p>Your course will be free and available on LMS.</p>
					</div>								
				</div>
				...
				<p class="crs_note">
					TIP: Your course should be priced: Fairly based on the amount and quality of course content. Competitively based on other courses found on LMS and other e-Learning sites.
				</p>
			</div>							
		</div>
...
<!--Help Poup-->
 ...
 <div class="help-popup" >
	...
	<div class="cont">
		<p><h3>Private</h3>
		"Private" courses are only accessible by direct URLs. They won't show up on LMS's site search. This is a terrific way to offer a course to an exclusive, select group of students.
		<ul>
		<li><strong>"Invitation Only" courses require instructors to invite students by email.</strong> <br />
